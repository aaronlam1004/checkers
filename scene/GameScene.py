...
class GameOverPopup(Popup):
    ...
    def create_buttons(self):
        ...
        play_again_button = Button(self.screen, (x, self.height), (button_width , button_height), "PLAY AGAIN", ButtonColors(), self.handle_play_again_button)
        quit_button = Button(self.screen, (x, self.height + button_height + 5), (button_width, button_height), "QUIT", ButtonColors(), self.handle_quit_button)
    ...
    def draw_title(self, player_id: int, player_color: Tuple[int, int, int]):
        ...
        y = self.height - (text_height + 12)

        border_text_render = title_font.render(text, False, (255, 255, 255))
        GraphicUtils.draw_text_border(self.screen, border_text_render, x, y, 8)
